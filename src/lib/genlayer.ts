...
import type { LabelBootstrap, TxState } from "@/lib/types";
...
export async function readProtocolBootstrap(): Promise<LabelBootstrap> {
  ...
  return result as unknown as LabelBootstrap;
}
